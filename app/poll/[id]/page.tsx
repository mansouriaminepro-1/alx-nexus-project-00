        ...
        try {
            ...
            if (!res.ok) {
                ...
                if (res.status === 403) {
                    ...
                    // We could show a specific error here, but the "Thank You" modal is already up.
                    // Maybe update the modal text? For now, we just log it.
                } else {
