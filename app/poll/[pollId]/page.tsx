...
import VoteConfirmationPopup from '../../../components/vote/VoteConfirmationPopup';
import ShareButtons from '../../../components/vote/ShareButtons';
...
export default function VotePage() {
    ...
    return (
        <>
            <UnifiedNavbar pollId={pollData.id} />
            <div className="min-h-screen bg-[#FAFAFA] pt-24 pb-20 font-sans relative overflow-x-hidden selection:bg-brand-yellow selection:text-brand-black">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="mt-16 text-center">
                        <div className="inline-flex flex-col items-center gap-4">
                            <p className="text-sm font-bold text-gray-400 uppercase tracking-wider">Love this battle?</p>
                            <ShareButtons pollId={pollData.id} pollTitle={pollData.title} />
                        </div>
                    </div>
                ...
                <VoteConfirmationPopup
                    isOpen={showConfirmation}
                    onClose={() => setShowConfirmation(false)}
                    itemName={pollData.items.find(item => item.id === selectedId)?.name || ''}
                    pollId={pollData.id}
                    onShare={() => {
